...
export type ReviewReasonCode = "LOW_MODEL_CONFIDENCE" | "STALE_GPS" | "MISSING_ZONE_CONTEXT" | "ELEVATED_RISK";
export type ApprovalReasonCode = "PERSISTENT_HIGH_RISK" | "ZONE_RISK_CORROBORATED" | "MULTIPLE_ELEVATED_VEHICLES";
